...
//             {
//                 SubFiles = new List<Luban.Protos.FileInfo>(),
//             };
//
//             try
//             {
...
//                             re.SubFiles.Add(new Luban.Protos.FileInfo() { FilePath = FileUtil.Standardize(subFile), MD5 = md5 });
//                         }
//                     }
//
//                 }
...
//                 else
//                 {
//                     re.Err = Luban.EErrorCode.FILE_OR_DIR_NOT_EXISTS;
//                 }
//             }
//             catch (Exception e)
//             {
//                 re.Err = Luban.EErrorCode.READ_FILE_FAIL;
//                 s_logger.Error(e);
//             }
//
...
//         {
//             long t1 = Bright.Time.TimeUtil.NowMillis;
//             var res = new GetInputFileRes() { Err = Luban.EErrorCode.OK };
//             try
//             {
//                 res.Content = await FileUtil.ReadAllBytesAsync(rpc.Arg.File);
//                 //res.Content = FileUtil.ReadAllBytes(rpc.Arg.File);
//                 res.Err = Luban.EErrorCode.OK;
//             }
//             catch (Exception)
//             {
//                 res.Err = Luban.EErrorCode.READ_FILE_FAIL;
//             }
