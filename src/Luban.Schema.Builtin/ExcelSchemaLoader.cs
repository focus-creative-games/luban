...
public class ExcelSchemaLoader : ISchemaLoader
{
    ...
    private ISchemaCollector _collector;
    
    public static ISchemaLoader Create(string type)
    {
        return new ExcelSchemaLoader(type);
    }
    
    private ExcelSchemaLoader(string type)
    {
        _type = type;
    }
    ...
    public void Load(string fileName, ISchemaCollector collector)
    {
        ...
        switch (_type)
        {
            case "table": LoadTable
        }
    }
    
    
    private RawBean LoadTableValueTypeDefineFromFile(RawTable rawTable, string dataDir)
    {
    ...
    private void LoadTableValueTypeDefinesFromFile(string dataDir)
    {
    ...
    private void LoadTableListFromFile(string fileName)
    {
        ...
        var defTable = new DefTable(new RawTable()
        {
