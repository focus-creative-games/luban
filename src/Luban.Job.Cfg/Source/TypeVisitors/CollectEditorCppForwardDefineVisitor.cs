...
{
    class CollectEditorCppForwardDefineVisitor : ITypeActionVisitor<HashSet<DefTypeBase>>
    {
        public static CollectEditorCppForwardDefineVisitor Ins { get; } = new CollectEditorCppForwardDefineVisitor();
